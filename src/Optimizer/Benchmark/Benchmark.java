...
import Optimizer.Algorithms.Coralreefs.SingleObjective.CoralReefs;
import Optimizer.Algorithms.ESPEA.MultiObjective.ESPEA;
import Optimizer.Algorithms.EvolutionStrategy.MultiObjective.PAES;
import Optimizer.Algorithms.EvolutionStrategy.SingleObjective.EvolutionStrategy;
import Optimizer.Algorithms.EvolutionStrategy.SingleObjective.NonElitistEvolutionStrategy;
import Optimizer.Algorithms.Genetic.MultiObjective.ParallelMOCell;
import Optimizer.Algorithms.Genetic.MultiObjective.ParallelNSGAII;
import Optimizer.Algorithms.Genetic.MultiObjective.ParallelNSGAIII;
import Optimizer.Algorithms.Genetic.MultiObjective.ParallelSPEA2;
import Optimizer.Algorithms.Genetic.MultiObjective.SMSEMOA;
import Optimizer.Algorithms.Genetic.SingleObjective.GA;
import Optimizer.Algorithms.Genetic.SingleObjective.ParallelGA;
import Optimizer.Algorithms.Genetic.SingleObjective.SteadyStateGA;
import Optimizer.Algorithms.RandomSearch.MultiObjective.RandomSearch;
	...
	public static void main(String[] args) throws IOException, ParserConfigurationException, TransformerException,
		...
		for (File script : RScripts) {
			if (script.getName().endsWith(".r")) {
				...
				keywords.addElement(
						new Parameter(args[0]+"/" + script.getName(), "",
