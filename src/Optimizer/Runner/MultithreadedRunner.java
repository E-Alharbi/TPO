...
public synchronized Tool GetTool() {
	...
	public  void Run() throws FileAlreadyExistsException, InterruptedException {
		...
		//System.out.println("Thread "+ Thread.currentThread().getId() +" assign to "+RunnerWorkingDir);
		...
		//Thread t1 = new Thread(new MultithreadedRunner(), "Thread "+String.valueOf(ThreadNumber));
