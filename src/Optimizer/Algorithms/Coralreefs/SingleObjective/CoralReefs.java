...
public class CoralReefs extends OptimizationAlgorithm {
	...
	public void init(IntegerProblem Problem) {
		algorithm = new CoralReefsOptimizationBuilder<IntegerSolution>(Problem, AlgorithmParameters.Selection,
				AlgorithmParameters.Crossover, AlgorithmParameters.Mutation).setM(AlgorithmParameters.CoralReefsM)
						.setN(AlgorithmParameters.CoralReefsN).setRho(AlgorithmParameters.CoralReefsRho)
						.setFbs(AlgorithmParameters.CoralReefsFbs).setFbr(AlgorithmParameters.CoralReefsFbr)
	...
	public List<IntegerSolution> RunCoralReefs() throws IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, ParserConfigurationException, TransformerException {
		ConfigurationReprot();
	...
	public void ConfigurationReprot() throws ParserConfigurationException, TransformerException, IllegalAccessException,
		...
		AddingGetter(AlgorithmParameters.Selection.getClass().getMethods(), element, AlgorithmParameters.Selection,
				xml.getDocument());
		rootElement.appendChild(element);
		...
		AddingGetter(AlgorithmParameters.Crossover.getClass().getMethods(), element, AlgorithmParameters.Crossover,
				xml.getDocument());
		rootElement.appendChild(element);
