...
public abstract class Genetic extends OptimizationAlgorithm {
	...
	public void ConfigurationReprot() throws ParserConfigurationException, TransformerException, IllegalAccessException,
		...
		AddingGetter(GAB.getSelectionOperator().getClass().getMethods(), element, GAB.getSelectionOperator(),
				xml.getDocument());
		rootElement.appendChild(element);
		...
		AddingGetter(GAB.getCrossoverOperator().getClass().getMethods(), element, GAB.getCrossoverOperator(),
				xml.getDocument());
		rootElement.appendChild(element);
		...
		// Class<? extends CrossoverOperator> cl =
		// GAB.getCrossoverOperator().getClass();
		AddingGetter(GAB.getMutationOperator().getClass().getMethods(), element, GAB.getMutationOperator(),
				xml.getDocument());
		rootElement.appendChild(element);
