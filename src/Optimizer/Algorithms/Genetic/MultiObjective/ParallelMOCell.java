...
public class ParallelMOCell extends Genetic{
	...
	public void init(IntegerProblem Problem) {
		...
		algorithm = new MOCellBuilder<IntegerSolution>(Problem, AlgorithmParameters.Crossover, AlgorithmParameters.Mutation)
		        ...
		        .setArchive(new CrowdingDistanceArchive<IntegerSolution>(AlgorithmParameters.archiveSize)).setSolutionListEvaluator(evaluator)
		        .build() ;
	}
}
