...
public class DependentParameter extends Parameter  {
	...
	public DependentParameter (String keyword, String value,ParameterType Parametertype , ValueType type , OptionsSet SetOfOptionsType,Parameter PrimaryParameter,boolean Optimize , boolean Combination) {
	...
	public DependentParameter (String keyword, String value, String SecondKeyword,ParameterType Parametertype , ValueType type , OptionsSet SetOfOptionsType,Parameter PrimaryParameter,boolean Optimize) {
